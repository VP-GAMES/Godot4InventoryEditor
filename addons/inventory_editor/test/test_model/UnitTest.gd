...
var _texture_fail = preload("res://addons/inventory_editor/test/test_model/icons/Fail.svg")
var _texture_success = preload("res://addons/inventory_editor/test/test_model/icons/Success.svg")
